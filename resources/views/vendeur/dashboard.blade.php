...
<nav class="top-nav">
    ...
    <div class="nav-right">
        <a href="{{ route('vendeur.show', auth()->id()) }}" class="nav-btn btn-outline"> Mon profil public</a>
...
<div class="page">
    ...
    <p class="page-sub">Tableau de bord de {{ $vendeur->name }}</p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="display:flex; gap:6px;">
                    <a href="/product/edit/{{ $product->id }}" style="
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @php $status = $item->order->status ?? 'En attente'; @endphp
                    <span class="badge
                        {{ $status === 'Validée' ? 'badge-valid' : ($status === 'Annulée' ? 'badge-cancel' : 'badge-pending') }}">
                        {{ $status }}
                    </span>
                </td>
