...
<head>
    ...
    <title>Commande #{{ $order->id }} – Maison Dagaz</title>
    <style>
...
<div class="topbar">
    ...
    <a href="{{ route('orders.index') }}" class="nav-btn btn-solid">← Mes commandes</a>
</div>
    ...
    <div class="card">
        ...
        <div class="meta">
            <div class="meta-item">
                ...
                <div class="value">{{ $order->created_at->format('d/m/Y à H:i') }}</div>
            </div>
            <div class="meta-item">
        ...
        <a href="{{ route('orders.index') }}" class="back-btn">← Retour aux commandes</a>
    </div>
</div>
