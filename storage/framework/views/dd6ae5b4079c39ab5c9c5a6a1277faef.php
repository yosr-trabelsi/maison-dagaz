...
<div class="topbar">
    ...
    <nav>
        ...
        <a href="<?php echo e(route('admin.orders')); ?>" class="active"> Commandes</a>
        <a href="/"> Boutique</a>
...
<div class="container">
    <div class="page-title"> Gestion des commandes <span style="font-size:16px;color:#bbb;">(<?php echo e($orders->count()); ?>)</span></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td style="color:#bbb;"><?php echo e($order->id); ?></td>
                <td><?php echo e($order->user ? $order->user->name : 'Invité'); ?></td>
                <td><strong><?php echo e(number_format($order->total, 2)); ?> TND</strong></td>
                <td>
                ...
                <td><?php echo e($order->created_at->format('d/m/Y à H:i')); ?></td>
                <td>
                    <form method="POST" action="<?php echo e(route('admin.orders.status', $order->id)); ?>" class="status-form">
                        <?php echo csrf_field(); ?>
                        <select name="status" class="status-select">
                            <option value="En attente" <?php echo e($order->status=='En attente' ? 'selected':''); ?>> En attente</option>
                            <option value="Validée"    <?php echo e($order->status=='Validée'    ? 'selected':''); ?>>Validée</option>
...
<?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/admin/orders.blade.php ENDPATH**/ ?>