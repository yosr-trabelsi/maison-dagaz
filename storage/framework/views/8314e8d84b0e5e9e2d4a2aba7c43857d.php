    ...
    <?php else: ?>
        <div class="contact-list">
            <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('chat.show', $contact->id)); ?>" class="contact-card">
                    <div class="avatar"><?php echo e(strtoupper(substr($contact->name, 0, 1))); ?></div>
                    <div class="contact-info">
                        <div class="contact-name"><?php echo e($contact->name); ?></div>
                        <div class="contact-preview"><?php echo e($contact->last_message ?? 'Aucun message'); ?></div>
                    </div>
                    <div class="contact-meta">
                        <?php if($contact->last_message_at): ?>
                            <span class="contact-time"><?php echo e(\Carbon\Carbon::parse($contact->last_message_at)->diffForHumans()); ?></span>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/chat/index.blade.php ENDPATH**/ ?>