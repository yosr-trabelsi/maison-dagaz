...
<div class="container">
    ...
    <form action="<?php echo e(url('/product/store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="name" placeholder="Ex : Robe de soirée" value="<?php echo e(old('name')); ?>" required>

        <label>Description</label>
        <textarea name="description" placeholder="Décrivez votre produit..." rows="4" required><?php echo e(old('description')); ?></textarea>

        <label>Prix (TND)</label>
        <input type="number" name="price" placeholder="0.00" step="0.01" min="0" value="<?php echo e(old('price')); ?>" required>

        <label>Catégorie</label>
        <select name="category" required>
            <option value="">-- Choisir une catégorie --</option>
            <option value="Robes"  <?php echo e(old('category')=='Robes' ? 'selected':''); ?>>Robes</option>
            <option value="Jupes"  <?php echo e(old('category')=='Jupes' ? 'selected':''); ?>>Jupes</option>
        </select>
...
<?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/create.blade.php ENDPATH**/ ?>