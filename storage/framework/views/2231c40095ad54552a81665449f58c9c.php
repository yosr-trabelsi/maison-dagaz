...
<div class="container">
    ...
    <div class="quick-links">
        ...
        <a href="<?php echo e(route('admin.products')); ?>" class="quick-link">
            <div class="ql-icon"></div>
            <div class="ql-label">Gérer les produits</div>
        </a>
        <a href="<?php echo e(route('admin.orders')); ?>" class="quick-link">
            <div class="ql-icon"></div>
    ...
    <div class="section-title">
        Derniers inscrits
        <a href="<?php echo e(route('admin.users')); ?>">Voir tous →</a>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td style="color:#bbb;"><?php echo e($user->id); ?></td>
...
<?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>