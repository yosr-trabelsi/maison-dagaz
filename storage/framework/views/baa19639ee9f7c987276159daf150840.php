...
<div class="topbar">
    ...
    <nav>
        ...
        <a href="<?php echo e(route('admin.products')); ?>" class="active"> Produits</a>
...
<div class="container">
    <div class="page-title">Gestion des produits <span style="font-size:16px;color:#bbb;">(<?php echo e($products->count()); ?>)</span></div>
            ...
            <tr>
                <td>
                    <?php if($product->image): ?>
                        <img src="<?php echo e(asset('images/' . $product->image)); ?>" class="thumb" alt="<?php echo e($product->name); ?>">
                    <?php else: ?>
                ...
                <td>
                    ...
                    <span style="font-size:12px;color:#aaa;"><?php echo e(Str::limit($product->description, 50)); ?></span>
                </td>
                <td><span class="badge-cat"><?php echo e($product->category); ?></span></td>
                <td><strong><?php echo e(number_format($product->price, 2)); ?> TND</strong></td>
                <td><?php echo e($product->user ? $product->user->name : '—'); ?></td>
                <td><?php echo e($product->reviews->count()); ?> ⭐</td>
                <td>
                    <div class="actions">
                        <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="btn-edit"> Modifier</a>
                        <form method="POST" action="<?php echo e(route('admin.products.delete', $product->id)); ?>"
                              onsubmit="return confirm('Supprimer le produit <?php echo e(addslashes($product->name)); ?> ?')">
...
<?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/admin/products.blade.php ENDPATH**/ ?>