...
<head>
    ...
    <title><?php echo e($vendeur->name); ?> – Maison Dagaz</title>
    <style>
...
<div class="vendeur-hero">
    <div class="vendeur-avatar"><?php echo e(strtoupper(substr($vendeur->name, 0, 1))); ?></div>
    <div class="vendeur-info">
        <h1><?php echo e($vendeur->name); ?></h1>
        ...
        <div class="vendeur-stats">
            ...
            <div class="stat">
                <div class="stat-value">
                    <?php if($totalRatings): ?>
                        <?php echo e(number_format($totalRatings, 1)); ?> ⭐
                    <?php else: ?>
                        —
                    <?php endif; ?>
                </div>
...
<!-- PRODUITS DU VENDEUR -->
<p class="section-title">PRODUITS DE <?php echo e(strtoupper($vendeur->name)); ?></p>
        ...
        <div class="card-body">
            ...
            <div class="card-rating">
                ...
                <?php if($avg): ?>
                    ...
                    <?php echo e(number_format($avg, 1)); ?> (<?php echo e($product->reviews->count()); ?> avis)
                <?php else: ?>
                    Aucun avis
                <?php endif; ?>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\maison-dagaz\maison-dagaz\resources\views/vendeur/show.blade.php ENDPATH**/ ?>